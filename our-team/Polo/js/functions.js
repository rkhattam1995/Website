...
!function(t) {
    ...
    INSPIRO.header = {
        ...
        logoStatus: function(i) {
            ...
            o.hasClass("header-sticky") && s.length > 0 ? (e.css("display", "none"),
            a.css("display", "none"),
            n.css("display", "none"),
            s.css("display", "block")) : (e.removeAttr("style"),
            a.removeAttr("style"),
            n.removeAttr("style"),
            s.removeAttr("style")),
            t(window).breakpoints("lessThan", "lg", function() {
                n.length > 0 && (e.css("display", "none"),
                a.css("display", "none"),
                s.css("display", "none"),
                n.css("display", "block"))
            })
        ...
        stickyHeader: function() {
            ...
            t(window).breakpoints("greaterEqualTo", "lg", function() {
                o.is(".header-disable-fixed") || (r > M + a ? (o.addClass("header-sticky"),
                r > M + s && (o.addClass("sticky-active"),
                g.submenuLight && g.headerHasDarkClass && (o.removeClass("dark"),
                g.headerDarkClassRemoved = !0),
                INSPIRO.header.logoStatus())) : (o.removeClass().addClass(n),
                g.sliderDarkClass && g.headerHasDarkClass && (o.removeClass("dark"),
                g.headerDarkClassRemoved = !0),
                INSPIRO.header.logoStatus()))
            }),
            t(window).breakpoints("lessThan", "lg", function() {
                "true" == o.attr("data-responsive-fixed") && (r > M + a ? (o.addClass("header-sticky"),
                r > M + s && (o.addClass("sticky-active"),
                g.submenuLight && (o.removeClass("dark"),
                g.headerDarkClassRemoved = !0),
                INSPIRO.header.logoStatus())) : (o.removeClass().addClass(n),
                1 == g.headerDarkClassRemoved && e.hasClass("mainMenu-open") && o.removeClass("dark"),
                INSPIRO.header.logoStatus()))
            })
        },
        topBar: function() {
        ...
        mainMenu: function() {
            if (l.length > 0) {
                    ...
                    t(window).breakpoints("lessThan", "lg", function() {
                        ...
                        l.animate({
                            ...
                            start: function() {
                                ...
                                g.sliderDarkClass && g.headerHasDarkClass && g.headerDarkClassRemoved && (o.removeClass("dark"),
                                g.headerDarkClassRemoved = !0)
                            },
                            duration: 500,
                        ...
                        g.menuIsOpen = !0,
                        g.submenuLight && g.headerHasDarkClass ? (o.removeClass("dark"),
                        g.headerDarkClassRemoved = !0) : g.headerHasDarkClass && g.headerDarkClassRemoved && o.addClass("dark"),
                ...
                t(window).on("resize", function() {
                    e.hasClass("mainMenu-open") && g.menuIsOpen && (d.trigger("click"),
                    l.find(".hover-active").removeClass("hover-active"))
                }),
                t(window).breakpoints("greaterEqualTo", "lg", function() {
        ...
        pageMenu: function() {
            ...
            e.length > 0 && (t(window).breakpoints("greaterEqualTo", "lg", function() {
                ...
                "true" == e.attr("data-sticky") && i.scroll(function() {
                    i.scrollTop() > t ? (e.addClass("sticky-active"),
                    o.addClass("pageMenu-sticky")) : (e.removeClass("sticky-active"),
        ...
        dotsMenu: function() {
            ...
            i.length > 0 && (e.on("click", function() {
                return e.parent("li").removeClass("current"),
                t(this).parent("li").addClass("current"),
                !1
            }),
            e.parents("li").removeClass("current"),
            i.find('a[href="#' + INSPIRO.header.currentSection() + '"]').parent("li").addClass("current"))
        },
    ...
    INSPIRO.slider = {
        ...
        inspiroSlider: function() {
            if (c.length > 0) {
                ...
                function d(t) {
                    t.find(".slide.is-selected").hasClass("slide-dark") && g.headerHasDarkClass ? (o.removeClass("dark"),
                    g.sliderDarkClass = !0,
                    g.headerDarkClassRemoved = !0) : (g.sliderDarkClass = !1,
                    g.headerDarkClassRemoved && g.headerHasDarkClass && !e.hasClass("mainMenu-open") && !o.hasClass("sticky-active") && o.addClass("dark"))
                }
                function u(e, a) {
                    o.outerHeight(),
                    s.outerHeight();
                    var n = i.height()
                      , r = (e.height(),
                    e.find(".slide"))
                      , l = (e.hasClass("slider-fullscreen"),
                    ...
                    function p(t) {
                        "null" == t ? (e.css("height", ""),
                        r.css("height", ""),
                        e.find(".flickity-viewport").css("height", "")) : (e.css("height", t),
                        r.css("height", t),
                ...
                c.each(function() {
                    ...
                    i.options = {
                        ...
                        adaptiveHeight: (i.data("adaptive-height"),
                        !1),
                        ...
                        setGallerySize: (i.data("gallery-size"),
                        !1),
                        resize: (i.data("resize"),
                        !1),
                    ...
                    i.find(".slide").length <= 1 && (i.options.prevNextButtons = !1,
                    ...
                    e.on("select.flickity", function() {
                        ...
                        e ? (e.play(),
                        a.options.autoPlay = Number(1e3 * e.duration)) : a.options.autoPlay = Number(i.options.autoPlay)
                    }),
        ...
        carousel: function(i) {
            ...
            u.length > 0) {
                ...
                u.each(function() {
                    ...
                    }) : (e = (a.options.containerWidth + Number(a.options.margin)) / i,
                    ...
                    1 !== Number(a.options.items) && t(window).on("resize", function() {
                        setTimeout(function() {
                            ...
                            a.options.autoWidth || o ? a.find(".polo-carousel-item").css({
                                "padding-right": a.options.margin + "px"
                            }) : a.hasClass("custom-height") ? (INSPIRO.core.customHeight(a.find(".polo-carousel-item")),
                            a.find(".polo-carousel-item").css({
                                width: e,
                                "padding-right": a.options.margin + "px"
                            })) : a.find(".polo-carousel-item").css({
    ...
    INSPIRO.elements = {
        ...
        forms: function() {
            ...
            i.length > 0 && i.each(function() {
                ...
                e.on("click", function(t) {
                    t.preventDefault(),
                    "text" == i.children("input").attr("type") ? (a.attr("type", "password"),
                    e.removeClass("icon-eye"),
                    e.addClass("icon-eye-off")) : "password" == i.children("input").attr("type") && (a.attr("type", "text"),
                    e.addClass("icon-eye"),
        ...
        formValidation: function() {
            ...
            Array.prototype.filter.call(t, function(t) {
                t.addEventListener("submit", function(i) {
                    !1 === t.checkValidity() && (i.preventDefault(),
                    i.stopPropagation()),
        ...
        formAjaxProcessing: function() {
            ...
            i.length > 0 && i.each(function() {
                ...
                Array.prototype.filter.call(i, function(t) {
                    t.addEventListener("submit", function(i) {
                        return !1 === t[0].checkValidity() && (i.preventDefault(),
                        i.stopPropagation()),
                        t.classList.add("was-validated"),
                        !1
                    }, !1)
                ...
                i.submit(function(n) {
                    ...
                    var r = t(this).attr("action")
                      ...
                      , d = t(this).serialize();
                    !1 === i[0].checkValidity() ? (n.stopPropagation(),
                    i.addClass("was-validated")) : (t(i).removeClass("was-validated"),
        ...
        other: function(e) {
            ...
            t(".toggle-item").length > 0 && t(".toggle-item").each(function() {
                ...
                i.on("click", function() {
                    return e && (a ? t(a).toggleClass(e) : i.toggleClass(e)),
            ...
            a.length > 0 && a.each(function() {
                ...
                e.find("> a").on("click", function() {
                    return e.toggleClass("dropdown-active"),
                    !1
                }),
        ...
        accordion: function() {
            ...
            t(".ac-title").on("click", function(i) {
                ...
                return a.hasClass("ac-active") ? s.hasClass("toggle") ? (a.removeClass("ac-active"),
                e.next(".ac-content").slideUp()) : (s.find(".ac-item").removeClass("ac-active"),
                s.find(".ac-content").slideUp()) : (s.hasClass("toggle") || (s.find(".ac-item").removeClass("ac-active"),
        ...
        animations: function() {
            ...
            if (i.length > 0) {
                ...
                i.each(function() {
                    ...
                    i.on("click", function() {
                        return i.addClass(i.options.animation),
                        !1
                    })),
        ...
        modal: function() {
            ...
            i.length > 0 && i.each(function() {
                ...
                if (i.find(s).click(function() {
                    return i.removeClass("modal-active"),
                    !1
                }),
            ...
            a.length > 0 && a.each(function() {
                var i = t(this)
                  , e = i.attr("data-modal");
                i.click(function() {
                    return t(e).toggleClass("modal-active", 1e3),
                    !1
                })
            })
        },
        notification: function(i, e, a, s, o, n, r, l, d, c) {
            ...
            l = l || "fadeOutDown";
            n = n || "top",
            s ? (u = "element-container",
            r = "fadeIn",
            l = "fadeOut") : u = "col-11 col-md-4",
                ...
                function a(i) {
                    i.each(function() {
                        ...
                        i.on("click", function() {
                            ...
                            return i.tooltip("hide").attr("data-original-title", e),
                            !1
                        })
                    })
                }
                i && (new ClipboardJS("[data-clipboard-target]"),
                a(i)),
                e && (new ClipboardJS("[data-clipboard-text]"),
                a(e))
            }
        },
        countdown: function() {
            ...
            if (i.length > 0) {
                ...
                i.each(function() {
                    ...
                    i.find(t("#instagram-cnt")).spectragram({
                        complete: (i.addClass("widget-instagram-loaded"),
            ...
            i.length > 0 && i.each(function() {
                ...
                i.submit(function(o) {
                    ...
                    var n = t(this).attr("action")
                      ...
                      , l = t(this).serialize();
                    !1 === i[0].checkValidity() ? (o.stopPropagation(),
                    i.addClass("was-validated")) : (t(i).removeClass("was-validated"),
